...
class PelaporPengaduan extends CI_Controller 
{
    ...
    public function addPelaporPengaduan()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            redirect('pelaporPengaduan'); // Redirect setelah berhasil menambahkan pengaduan
        }
    }
    ...
    public function editPelaporPengaduan($id_pengaduan)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            redirect('pelaporPengaduan'); // Redirect setelah berhasil mengedit pengaduan
        }
    }
    ...
    public function removePelaporPengaduan($id_pengaduan)
    {
        ...
        redirect('pelaporPengaduan'); // Redirect setelah berhasil menghapus pengaduan
    }
}
