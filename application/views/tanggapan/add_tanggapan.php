			  ...
			  <div class="card-body">
			  	<form action="<?= base_url('tanggapan/addTanggapan/' . $pengaduan['id_pengaduan']); ?>" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<a href="<?= base_url('assets/img/img_tanggapan/Default.jpeg'); ?>" class="enlarge" id="check_enlarge_photo">
								<img class="img-fluid rounded img-w-150 border border-dark" id="check_photo" src="<?= base_url('assets/img/img_tanggapan/Default.jpeg'); ?>" alt="Foto Tanggapan">
							</a>
							<br>
						</div>
