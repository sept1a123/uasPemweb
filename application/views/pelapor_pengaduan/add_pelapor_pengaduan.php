			  ...
			  <div class="card-body">
	              ...
	              <?= form_error('id_kelurahan'); ?>
						...
						<div class="form-group">
							...
							<a href="<?= base_url('assets/img/img_pengaduan/Default.jpeg'); ?>" class="enlarge" id="check_enlarge_photo">
								<img class="img-fluid rounded img-w-150 border border-dark" id="check_photo" src="<?= base_url('assets/img/img_pengaduan/Default.jpeg'); ?>" alt="Foto Pengaduan">
							</a>
							<br>
						</div>
